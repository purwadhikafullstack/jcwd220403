...
router.patch('/api/user/profilePic',  multerUpload.single("file"), userControllers.updateProfilePic);
...
router.post('/api/user/verification', userControllers.verification);
