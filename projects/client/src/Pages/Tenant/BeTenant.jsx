...
function BeTenant() {
  ...
  const isSubmitClicked = useSelector(
    (state) => state.ButtonSlice.isSubmitClicked
  );
          ...
          >
            ...
            <Flex>
              ...
              <Button
                ...
                style={{ opacity: isSubmitClicked ? 1 : 0.5 }}
                marginBottom='10px'
                color='white'
                padding='25px'
                _hover={{ borderRadius: '10px' }}
              >
                {load ? <Spinner color='white' /> : 'Berikutnya'}
              </Button>
            </Flex>
          </Box>
        </Box>
          ...
          >
            ...
            <Flex>
              ...
              <Button
                ...
                marginRight='20px'
                isDisabled={isSubmitClicked}
                style={{ opacity: isSubmitClicked ? 0.5 : 1 }}
                marginBottom='10px'
                color='white'
                padding='25px'
                _hover={{ borderRadius: '10px' }}
          ...
          >
            ...
            <Flex>
              ...
              <Button
                ...
                _hover={{ borderRadius: '10px' }}
              >
                {pulseLoader ? <Spinner color='white' /> : 'Berikutnya'}
              </Button>
            </Flex>
          </Box>
        </Box>
