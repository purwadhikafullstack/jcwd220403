    ...
    <Container maxW={'7xl'}>
      ...
      >
        <Stack flex={1} spacing={{ base: 5, md: 10 }}>
          ...
          <Stack>
            <Text color={'gray.500'}>
              Our community is safer when our Hosts are verified. Start by
              letting us know if you're a team of one, hosting with others, or
              managing this account on behalf of a business.
            </Text>
            <Text fontWeight={'bold'}>Why it's important</Text>
            <UnorderedList color={'gray.500'} paddingLeft={7}>
              <ListItem>
                Inaccurate info can delay getting paid on time These details are
              </ListItem>
              <ListItem>
                required by law Verification keeps our community safe
              </ListItem>
            </UnorderedList>
          </Stack>
          <Stack
