        ...
        <Flex flexDirection='column'>
          <Box flex='1' display='flex' flexDirection='column' padding='20px'>
            ...
            <Text margin='20px 0px' fontSize='sm'>
              ...
              ipsa illo voluptatibus voluptatem tempore quae iste recusandae
              commodi qui, veniam nihil dignissimos blanditiis eveniet natus
          ...
          <Box flex='1' padding='20px' display='none'>
            <Text marginBottom='30px' fontWeight='bold'>
              Useful Links
            </Text>
          ...
          <Box flex='1' padding='20px' backgroundColor='#fff8f8'>
            ...
            <Box marginBottom='20px' display='flex' alignItems='center'>
              <Text marginRight='10px'>
                Jakarta Selatan, Gedung Sinarmas Lt.13
              </Text>
            </Box>
            <Box marginBottom='20px' display='flex' alignItems='center'>
              ...
              <Flex>
                ...
                >
                  ...
                  <Text margin='20px 0px'>
                    ...
                    Enim eos ipsa illo voluptatibus voluptatem tempore quae iste
                    recusandae commodi qui, veniam nihil dignissimos blanditiis
                    eveniet natus fugit provident inventore facilis.
                  </Text>
                  <Box display='flex'>
                    <Icon
                      as={FiTwitter}
