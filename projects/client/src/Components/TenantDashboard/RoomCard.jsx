                                    ...
                                    <Slider
                                        ...
                                        {item.images && item.images.map((image, i) => (
                                            <Box key={i} onMouseEnter={() => setIndexImages(index)} onMouseOut={() => setIndexImages(-1)}>
                                                <Image cursor="pointer" height="150px" width="100%" objectFit="cover" borderRadius="5px" src={process.env.REACT_APP_URL_PUBLIC + 'roomPicture/' + image.picture}/>
                                            </Box>
                                        ))}
                                    </Slider>
                                </Box>
                                                        ...
                                                        <Flex justifyContent="center" alignItems="center" flexWrap="wrap" gap="10px">
                                                            ...
                                                            >
                                                                <Image
                                                                    ...
                                                                    src={process.env.REACT_APP_URL_PUBLIC + 'roomPicture/' + image.name}
                                                                    alt='Caffe Latte'
                                                                />
