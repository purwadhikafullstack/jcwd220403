  ...
  return (
    <Box>
      ...
      >
        ...
        <DrawerContent>
          <DrawerCloseButton
            onClick={() => dispatch(closeDrawerForMorePicture())}
          />
          <DrawerHeader textAlign="center" fontFamily="poppins">
            Create more picture for your property
          </DrawerHeader>
